...
return new class extends Migration
{
    ...
    {
        Schema::create('iam_principal_posts_likes_links', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('like_icons_xid');
            $table->foreign('like_icons_xid')->references('id')->on('like_icons')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('iam_principal_posts_likes_links');
    }
};
